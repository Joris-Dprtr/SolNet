...
class DataFetcher:
    ...
    Methods:
    - init: set all the key parameters required for PVGIS and gather the data by executing _data_gathering
    - _data_gathering: gather data from PVGIS based on the parameters given in the init
    - save_data: save the data in a pickle file
    """
    ...
    def __init__(
        ...
        self.pv = pvgis.PVgis(latitude, longitude, start_date, tilt, azimuth, peakPower)
